  ...
  return (
    <div className="w-full overflow-x-hidden">
      ...
      <div className="flex flex-col bg-black font-inter">
        ...
        <p className="text-[#A6A6A6] text-center py-12">Não tenha medo de denunciar, isso pode salvar o seu e o futuro de diversas pessoas LBGBTQIA+</p>
        {/* FOOTER */}
        <img src="./Footer.svg" className="w-[100%]" />
